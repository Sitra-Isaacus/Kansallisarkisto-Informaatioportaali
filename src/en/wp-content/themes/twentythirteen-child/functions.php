...
function register_my_menu() {
  ...
  register_nav_menu('footer-menu',__( 'Alapalkin valikko' ));
...
function twentythirteen_widgets_init() {
	...
	register_sidebar( array(
		...
		'name'          => __( 'Alapalkin sivunavigaation linkit 1', 'twentythirteen' ),

		'id'            => 'ala1',

		'description'   => __( 'Alapalkin sivunavigaation linkit 1', 'twentythirteen' ),
	...
	register_sidebar( array(
		...
		'name'          => __( 'Alapalkin sivunavigaation linkit 2', 'twentythirteen' ),

		'id'            => 'ala2',

		'description'   => __( 'Alapalkin sivunavigaation linkit 2', 'twentythirteen' ),
	...
	register_sidebar( array(
		...
		'name'          => __( 'Alapalkin sivunavigaation linkit 3', 'twentythirteen' ),

		'id'            => 'ala3',

		'description'   => __( 'Alapalkin sivunavigaation linkit 3', 'twentythirteen' ),
	...
	register_sidebar( array(
		...
		'name'          => __( 'Alapalkin sivunavigaation linkit 4', 'twentythirteen' ),

		'id'            => 'ala4',

		'description'   => __( 'Alapalkin sivunavigaation linkit 4', 'twentythirteen' ),
	...
	register_sidebar( array(
		...
		'name'          => __( 'Alapalkin sivunavigaation linkit 5', 'twentythirteen' ),

		'id'            => 'ala5',

		'description'   => __( 'Alapalkin sivunavigaation linkit 5', 'twentythirteen' ),
	...
	register_sidebar( array(
		...
		'name'          => __( 'Alapalkin päälinkit', 'twentythirteen' ),

		'id'            => 'ala-main',

		'description'   => __( 'Alapalkin päälinkit', 'twentythirteen' ),
